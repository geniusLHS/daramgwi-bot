...
const FAQs = [
  {
    ...
    A: '세션이 만료된 것일 수 있으니, 로그아웃 뒤 다시 로그인 해주세요. 만약 재 로그인 후에도 동일하다면, 실제로 자습 신청을 할 수 없는 상황일 수 있습니다.',
  },
  {
  ...
  {
    Q: '토요일에 "주말 자습 신청" 페이지에 들어갔을 때 토요일 신청 칸에 아무것도 없는 이유는 무엇인가요?',
    A: '다람쥐봇은 학생 현황 관리 시스템의 정보를 그대로 보여주는 역할을 합니다. 토요일이 되면 학생 현황 관리 시스템의 휴일 학습 프로그램 신청 탭에서 토요일 신청 칸이 없어지므로, 다람쥐봇에서도 볼 수 없습니다.',
  },
];
